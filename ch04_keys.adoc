...
correspond to the same 256-bit number. See <<table_4-2>>.
...
added one-byte suffix (shown as 01 in hex in <<table_4-4>>).
...
might find this pattern in a Bitcoin address (see <<table_4-12>>).
