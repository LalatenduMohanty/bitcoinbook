...
<ol start="7">
  ...
  _entropy_ produced from step 6.</li>

  <li>The second parameter to the PBKDF2 key-stretching function is a
  _salt_. The salt is composed of the string constant
...
Tables <<bip39_128_no_pass>>,
<<bip39_128_w_pass>>, and
<<bip39_256_no_pass>> show
...
<tr>
<td><p>m/0'/0</p></td>
<td><p>The first normal grandchild private key from the first _hardened_ child (m/0')</p></td>
</tr>
<tr>
<td><p>m/1/0</p></td>
