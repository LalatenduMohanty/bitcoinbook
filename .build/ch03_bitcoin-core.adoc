...
<dd><p>This overrides the default installation location (which is _/usr/local/_) for the resulting executable. Use <code>$HOME</code> to put everything in your home directory, or a different path.</p></dd>
